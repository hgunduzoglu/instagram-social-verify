 ...
 * @returns
 */
export declare function verifyDKIMSignature(email: Buffer | string, domain?: string, enableSanitization?: boolean, fallbackToZKEmailDNSArchive?: boolean, skipBodyHash?: boolean): Promise<DKIMVerificationResult>;
