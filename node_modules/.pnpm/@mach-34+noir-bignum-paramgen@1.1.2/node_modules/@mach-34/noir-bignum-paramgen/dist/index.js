...
exports.computeBarrettReductionParameter = computeBarrettReductionParameter;
exports.splitInto120BitLimbs = splitInto120BitLimbs;
exports.bnToLimbStrArray = bnToLimbStrArray;
exports.bnToRedcLimbStrArray = bnToRedcLimbStrArray;
/**
 ...
 *                            modulus
 */
function computeBarrettReductionParameter(input, numBits) {
    ...
    if (numBits === undefined)
        ...
        if (actualBits > numBits)
            throw new Error("Given bits for bignum limbs is too small");
    }
    // multiplicand = 2^(2 * k)
 ...
 */
function bnToLimbStrArray(input, numBits) {
    // Convert hex string to BigInt if necessary
    let bn;
    if (typeof input === 'string') {
        // Remove '0x' prefix if present and convert to BigInt
 ...
 * @returns - An array of strings, each representing a 120-bit limb in "0x..." hexadecimal format
 */
function bnToRedcLimbStrArray(bn, numBits) {
