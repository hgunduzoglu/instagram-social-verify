...
import { bigintConfigHelper, getConfigFromMappings, getDefaultConfig, numberConfigHelper } from '@aztec/foundation/config';
...
export class ReadOnlyL1TxUtils {
    ...
    config;
    interrupted;
    constructor(client, logger = createLogger('ReadOnlyL1TxUtils'), config, debugMaxGasLimit = false){
        this.client = client;
        this.logger = logger;
   ...
   */ async estimateGas(account, request, _gasConfig, _blobInputs) {
    ...
    async _simulate(call, blockOverrides = {}, stateOverrides = [], gasConfig) {
        try {
...
export class L1TxUtils extends ReadOnlyL1TxUtils {
    client;
    logger;
    constructor(client, logger = createLogger('L1TxUtils'), config, debugMaxGasLimit = false){
        super(client, logger, config, debugMaxGasLimit), this.client = client, this.logger = logger;
