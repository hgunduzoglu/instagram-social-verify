...
export declare class PrivateKernelResetDimensions {
    ...
    PRIVATE_LOG_SILOING_AMOUNT: number;
    constructor(NOTE_HASH_PENDING_AMOUNT: number, NOTE_HASH_SETTLED_AMOUNT: number, NULLIFIER_PENDING_AMOUNT: number, NULLIFIER_SETTLED_AMOUNT: number, NULLIFIER_KEYS: number, TRANSIENT_DATA_AMOUNT: number, NOTE_HASH_SILOING_AMOUNT: number, NULLIFIER_SILOING_AMOUNT: number, PRIVATE_LOG_SILOING_AMOUNT: number);
    toBuffer(): Buffer;
