...
export type ClientCircuitName = 'private-kernel-init' | 'private-kernel-inner' | 'private-kernel-reset' | 'private-kernel-tail' | 'private-kernel-tail-to-public' | 'app-circuit';
export type ServerCircuitName = 'base-parity' | 'root-parity' | 'private-base-rollup' | 'public-base-rollup' | 'merge-rollup' | 'block-root-rollup' | 'single-tx-block-root-rollup' | 'empty-block-root-rollup' | 'block-merge-rollup' | 'root-rollup' | 'avm-circuit' | 'tube-circuit';
