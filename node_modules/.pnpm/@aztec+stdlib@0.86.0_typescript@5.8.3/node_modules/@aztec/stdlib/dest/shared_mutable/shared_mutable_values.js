...
export class SharedMutableValues {
    ...
    static fromFields(fields) {
        ...
        const sdc = new ScheduledDelayChange(sdcIsPreSome ? Number(sdcPre) : undefined, sdcIsPostSome ? Number(sdcPost) : undefined, Number(sdcBlockOfChange));
    ...
    static async readFromTree(sharedMutableSlot, readStorage) {
        const fields = [];
