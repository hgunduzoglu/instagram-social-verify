...
import { SnapshotDataKeys, type SnapshotDataUrls, type SnapshotMetadata, type SnapshotsIndex, type SnapshotsIndexMetadata } from './types.js';
export declare function getSnapshotIndex(metadata: SnapshotsIndexMetadata, store: ReadOnlyFileStore): Promise<SnapshotsIndex | undefined>;
...
export declare function makeSnapshotLocalPaths(baseDir: string): SnapshotDataUrls;
