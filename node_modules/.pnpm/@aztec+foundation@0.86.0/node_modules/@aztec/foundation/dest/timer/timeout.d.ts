...
export declare class TimeoutTask<T> {
    ...
    private interrupt;
    private totalTime;
    constructor(fn: () => Promise<T>, timeout: number, errorFn: () => any);
    /**
...
export declare function executeTimeout<T>(fn: () => Promise<T>, timeout: number, errorOrFnName?: string | (() => any)): Promise<T>;
